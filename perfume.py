...
# ===============================
# DATABASE AUTO SETUP (PUBLIC READY)
# ===============================
...
def setup_database():
    ...
    try:
        # Ask user for password (no hardcoding)
        ...
        # Create DB
        cur.execute("CREATE DATABASE IF NOT EXISTS Perfume_shop")
        cur.execute("USE Perfume_shop")
        ...
        if count == 0:
            ...
            VALUES
            ('Dior Sauvage','Dior',4500,10),
            ('Chanel No 5','Chanel',5200,8),
            ('Gucci Flora','Gucci',3900,6)
            """)
            con.commit()
